...
# Get dir where tesy is 
PROJECT_ROOT="$(cd "$(dirname "$0")/.." && pwd)"

INPUT_FILE="$PROJECT_ROOT/test_input_files/test_input_1.txt"
EXPECTED_OUTPUT="$PROJECT_ROOT/test_output_files/test_output_1.asm"
ACTUAL_OUTPUT="$PROJECT_ROOT/nasm_out.s"
COMPILER="$PROJECT_ROOT/build/testy"
